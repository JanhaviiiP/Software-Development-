...
GoogleSignin.configure({
  webClientId: '304266856921-7bhtrfabgol61ofnod8rkjt5ksqtb13c.apps.googleusercontent.com',
  offlineAccess: true
});
...
const primaryColor = '#72A1E5';  // Define primary color for ease of use
    ...
    <DrawerContentScrollView {...props}>
      <View style={{ flex: 1 }}>
        <View style={styles.drawerHeader}>
          <Text style={styles.drawerHeaderText}>Pre Food</Text>
        </View>
        <DrawerItemList {...props} />
      </View>
      <View style={styles.drawerFooter}>
        <Button title="Sign Out" onPress={signOut} color="grey" />
      </View>
...
const generalHeaderStyle = {
  headerStyle: {
    backgroundColor: '#72A1E5',  // Background color of the header
  },
